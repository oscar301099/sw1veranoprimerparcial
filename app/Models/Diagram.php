...
class Diagram extends Model
{
    ...
    protected $fillable = ['name', 'description', 'content', 'finished', 'project_id'];
    ...
    {
        return $this->belongsToMany(User::class, 'diagram_collaboration');
    }

    public function diagramCollaboration()
    {
        return $this->hasMany(DiagramCollaboration::class);
    }

    public function permission($user_id)
    {
        $relationship = $this->diagramCollaboration()->where('user_id', $user_id)->first();
        $relationship = $relationship->edit;
        return $relationship;
    }
